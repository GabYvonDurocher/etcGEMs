...
`strains/eciML1515/outputs/_archive/` is gitignored by name. Two known exceptions are listed
in the TASK 5 note rather than silently fixed: `strains/eciML1515/outputs/tpc/` no longer
