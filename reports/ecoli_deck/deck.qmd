...
- Nested sampling returns evidence with the posterior. D on NLDM currently gives **$-26.030\pm0.109$ from seed 1**. It is a provisional starting value, not a D/E/F comparison; changing the likelihood requires a new D result too
