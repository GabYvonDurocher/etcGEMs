...
cd "/Users/g.yvon-durocher/Library/CloudStorage/OneDrive-UniversityofExeter/Documents/work/MICROADAPT/etcGEMs-t2"
unset CANDIDAS_ROOT
...
$P reports/candida_thermal_limit/gate_table.py > /tmp/t2_gate_table.out 2>&1; echo "gate_table rc=$?"; grep -E "comparisons" /tmp/t2_gate_table.out | tail -1
$P reports/P1_parsa_port/gate.py > /tmp/t2_gate_p1.out 2>&1; echo "P1 gate rc=$?"; grep -E "comparisons" /tmp/t2_gate_p1.out | tail -1
