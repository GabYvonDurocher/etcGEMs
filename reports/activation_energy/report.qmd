...
![**How $E_a^\text{org}$ emerges (rich medium, tuned model).** A waterfall from the enzyme-kinetic backbone — the control-weighted mean of the per-enzyme $E_{a,i}$ (0.970 eV) — through the growth-law allocation ($-0.107$) and temperature-dependent maintenance ($-0.010$) offsets and a small nonlinear residual to the actual $E_a^\text{org}=0.909$ eV.](assets/figures/ea_waterfall.png){#fig-waterfall fig-pos="H" width=80%}
