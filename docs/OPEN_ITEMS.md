...
_Started 2026-09-08 while P2 was running; last updated 2026-09-08 by K8._ This is the standing list of what is outstanding across
...
| 3.17 | **The Candida ceiling has at least two components and one of them is unidentified.** K8 sized them: a predictor term of ≈5.4 K (A1's measured Seq2Tm bias, which closes a third to a half of the gap at exactly its measured value without touching the rising limb) and a common term of ≈5.6 K that appears in *E. coli* too, where Tm are **measured** and predictor bias is impossible. Their sum ≈11 K matches *C. auris*' required 10 °C; the three relatives need 15 °C, leaving **≈4 °C species-specific and unexplained**. | Whenever the ceiling is load-bearing. The common ≈5.6 K term is the one nobody has a mechanism for and it is shared with *E. coli*, so it is testable there too once P4 lands. The species-specific ≈4 °C residual is the divergence itself and is what K2's 13.8 °C requirement is about. |
