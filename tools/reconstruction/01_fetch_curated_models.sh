#!/bin/bash
# =============================================================================
# 01_fetch_curated_models.sh - get the two curated Candida GEMs. Run on the Mac.
#   bash tools/reconstruction/01_fetch_curated_models.sh
#
# PORTED from the standalone Candida etcGEM (Candidas `gem/`). The only change is that
# the destination is the configurable work area (common.sh) rather than gem/models/.
#
...
echo
echo "Then:  python3 tools/reconstruction/02_inspect_models.py"
