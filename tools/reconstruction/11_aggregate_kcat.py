...
median-over-substrates alternative is tested in <work>/audits/sens_medium_kcat.py and does not
change the conclusion.

Input   <work>/tables/kcat_<species>.tsv        DLKcat output (Substrate Name = gene|reaction|kegg)
Output  <work>/tables/kcat_reaction_<species>.csv
...
Run:  python3 tools/reconstruction/11_aggregate_kcat.py
