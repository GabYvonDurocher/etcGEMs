...
Output  <work>/tables/seq2topt_input.csv        3042 rows (704 / 679 / 662 / 997 per species)
Run:    python3 tools/reconstruction/13_seq2topt_input.py     then bash tools/reconstruction/14_run_seq2topt_seq2tm.sh
