...
Outputs
    <work>/tables/dlkcat_pairs_<species>.tsv     reaction, gene, substrate_kegg
    <work>/inputs/kegg_compounds_needed.txt      the union of substrates, for 12_fetch_kegg_smiles.py
    <work>/tables/dlkcat_input_<species>.tsv     DLKcat's input format (Substrate Name, Substrate
                                              ...
                                              Written only when <work>/inputs/kegg_smiles.tsv exists.
Run:  python3 tools/reconstruction/09_dlkcat_pairs.py        then 12_fetch_kegg_smiles.py (once), then re-run
